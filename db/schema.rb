...
ActiveRecord::Schema.define(version: 20141028194724) do
  ...
  create_table "mission_results", force: true do |t|
  ...
  add_index "mission_results", ["mission_id"], name: "index_mission_results_on_mission_id"
