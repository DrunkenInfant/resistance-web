...
* Let everyone vote on a suggestion.
  ...
  - Backend, let client request voting results
  - Backend, whithhold voting details until all votes are in
  - Backend, only accept nomination if all other nominations in this mission have been voted on.
  - DONE: Frontend, display vote view on nomination created
  - DONE: Frontend, let player vote

* Only let one nomination to be created at a time (BACKEND)
  - ...
