...
* Enable suggesting teams, all team members at the same time.
  ...
  - Only allow nominating correct number of players
...
* If a suggestion passes, let all participating players choose fail or success.
  - Backend: Let nominated players choose result
  - Backend: Only allow one result per nominated player
  - Backend: Never leak the user of a result
