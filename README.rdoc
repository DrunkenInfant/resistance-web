...
* Let all spies see who the other spies are
...
* If a suggestion passes, let all participating players choose fail or success.
  ...
  - Backend: Resistance players may only choose success
...
* DONE Implement websockets to push updates to clients

* Use websockets to push updates to non logged in sessions

==== UI ====

* INVALID collapse player list on small screens

* INVALID Current activity area above game board area

* DONE Display current king with a crown symbol

* Hide success/fail buttons when result is submitted
  - DONE Backend: return player of a result if it is current player
  - DONE Frontend:

* DONE Use avatars to display players

* Add link and form to create new game

* List all games

==== Bugs ====

* FIXED: Advance king when last nomination is hammered
